...
const TRANSLATIONS = {
  en: {
    ...
    'column.title': 'title',
    'column.open': 'open',
    'settings.notifyClaudeOpen': 'Claude notifications: open in VS Code. Claude Desktop transfer is not available here yet.',
    'settings.notifyCodexOpen': 'Open Codex notifications in',
    'settings.notifyOpenHelp': 'Applies to the notification body and its Open button, including notifications already displayed. Save to apply without restarting. The table buttons keep their explicit destinations.',
  ...
  fr: {
    ...
    'column.title': 'titre',
    'column.open': 'ouvrir',
    'settings.notifyClaudeOpen': 'Notifications Claude : ouverture dans VS Code. Le transfert vers Claude Desktop n’est pas encore disponible ici.',
    'settings.notifyCodexOpen': 'Ouvrir les notifications Codex dans',
    'settings.notifyOpenHelp': 'S’applique au clic sur la notification et à son bouton Ouvrir, même pour les notifications déjà affichées. Enregistrer applique le choix sans redémarrage. Les boutons du tableau gardent leur destination explicite.',
