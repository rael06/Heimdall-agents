...
const TRANSLATIONS = {
  en: {
    ...
    'rowMenu.status': 'Set the status…',
    'rowMenu.transcript': 'Show the transcript',
    'rowMenu.provider': 'Provider colour…',
    'rowMenu.workspace': 'Workspace colour…',
    'rowMenu.group': 'Group',
  ...
  fr: {
    ...
    'rowMenu.status': 'Définir le statut…',
    'rowMenu.transcript': 'Afficher le transcript',
    'rowMenu.provider': 'Couleur du fournisseur…',
    'rowMenu.workspace': 'Couleur du workspace…',
